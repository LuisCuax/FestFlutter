...
class _MyRequestsScreenState extends State<MyRequestsScreen> {
  ...
  List<Map<String, dynamic>> get _filteredRequests {
    ...
    if (_activeFilter == 'Confirmados') {
      return _requests.where((r) => r['status'] == 'hired').toList();
    }
    if (_activeFilter == 'Finalizados') {
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final displayCategory =
                              categoryName.toLowerCase() == 'floristeria'
                              ? 'Floreria'
                              : categoryName;
                                      ...
                                      children: [
                                        IconButton(
                                          ...
                                          onPressed: () => context.push(
                                            '/chats',
                                            extra: {'requestId': item['id']},
                                          ),
                                        ),
                                        ElevatedButton(
                                          onPressed: () => context.push(
                                            '/request-detail/${item['id']}',
                                          ),
